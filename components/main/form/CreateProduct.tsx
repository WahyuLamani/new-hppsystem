...
import { CameraIcon, ChevronDown, Save, X } from "lucide-react";
          ...
          <section className="space-y-4">
            ...
            <div className="relative group">
              <label htmlFor="image-input" className="cursor-pointer block">
                <div
                  className={clsx(
                    "aspect-[4/3] w-full rounded-lg overflow-hidden border-2 border-dashed transition-colors",
                    preview
                      ? "border-primary-container"
                      : "border-outline-variant bg-surface-container-highest hover:bg-surface-container flex flex-col items-center justify-center space-y-2"
                  )}
                >
                  {preview ? (
                    <img
              ...
              {/* Tombol hapus foto, muncul hanya jika ada preview */}
              {preview && (
                <button
                  type="button"
