...
export default function CreateProduct({categories}: {categories: Categories[]}){
    ...
    const {register,handleSubmit,watch,formState:{errors,isSubmitting},} = useForm<ProductFormData>({resolver: zodResolver(ProductSchema)})
    ...
    <>
      ...
      <div className="flex-1 px-6 space-y-8 mt-4">
        ...
        <section className="space-y-4">
          <label className="font-bold text-primary tracking-tight">Foto Produk</label>
          <div className="aspect-[4/3] w-full rounded-lg bg-surface-container-highest overflow-hidden border-2 border-dashed border-outline-variant flex flex-col items-center justify-center space-y-2 hover:bg-surface-container transition-colors">
            ...
            <p className="text-sm font-medium text-on-surface-variant">Klik untuk unggah foto</p>
            <p className="text-[10px] text-outline uppercase tracking-widest">PNG, JPG up to 5MB</p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="font-bold text-primary text-xl">Detail Artisan</h2>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className={clsx(
                  ...
                  errors.name ? "ring-2 ring-error" : "focus:ring-primary-container"
                )}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className={clsx(
                      ...
                      errors.category_id ? "ring-2 ring-error" : "focus:ring-primary-container"
                    )}
                  >
                ...
                {errors.category_id && (
                  <p className="text-xs text-error px-1">{errors.category_id.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={clsx(
                    "w-full bg-surface-container-lowest border-none rounded-DEFAULT px-4 py-4 text-on-surface placeholder:text-outline/50 focus:ring-2 shadow-sm font-medium",
                    errors.unit ? "ring-2 ring-error" : "focus:ring-primary-container"
                  )}
                  placeholder="Box"
                  type="text"
                />
                {errors.unit && (
                  <p className="text-xs text-error px-1">{errors.unit.message}</p>
                )}
              </div>
            </div>
          </div>
        ...
        <section className="bg-surface-container-low rounded-lg p-6 space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={clsx(
                  ...
                  errors.selling_price ? "ring-2 ring-error" : "focus:ring-primary-container"
                )}
                placeholder="0"
                type="number"
              />
            ...
            {errors.selling_price && (
              <p className="text-xs text-error px-1">{errors.selling_price.message}</p>
            )}
          </div>

          <div className="grid grid-cols-5 gap-3">
            <div className="col-span-3 bg-primary p-4 rounded-DEFAULT flex flex-col justify-between text-on-primary">
              <span className="text-[10px] uppercase tracking-widest font-bold opacity-70">Estimated Margin</span>
            ...
            <div className="col-span-2 bg-tertiary-fixed p-4 rounded-DEFAULT flex flex-col justify-between">
              <span className="text-[10px] uppercase tracking-widest font-bold text-on-tertiary-fixed opacity-70">Status</span>
              <span className="text-sm font-bold text-on-tertiary-fixed mt-2">HEALTHY</span>
            </div>
          </div>
        </section>
        ...
        <section className="pt-4 pb-8">
          <button
            ...
            className={clsx(
              ...
              isSubmitting ? "opacity-60 scale-[0.98]" : "active:scale-[0.98]"
            )}
          >
